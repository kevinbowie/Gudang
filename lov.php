...
//http://localhost/lov.php?lov=tampilrelasi&id=$id&from=0
	...
	//echo $param.'<br />';
	if ($param=="lov_barang"){
		$title = "LOV Jenis Barang";
		$ssql1 = "Select id, namabarang, hpp From mst_stocks Where kodept like 'CSC%' %filter Order By id Limit %from, %perpage;";
		$ssql2 = "Select Count(*) From mst_stocks Where kodept like 'CSC%' %filter;";
		$num  = 3;
